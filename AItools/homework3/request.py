    ...
    async def run(self, input_file: str, output_file: str, batch_size: int, batch_group_size: int, max_concurrent: int):
        ...
        try:
            with open(input_file, 'r', encoding='utf-8') as f:
                ...
                '''
                test_data data_type:[a,b,c,……]
                a data_type:{'prompt', 'solution','num_clues', 'evalutation':'aa, bb, cc, ……'}
                aa data_type:{'difficulty_score', 'difficulty_level','metrics', 'statistics', 'style'}
                '''
...
def main():
    ...
    parser.add_argument("--max-retries", type=int, default=10, help="Max retry times for each request")
    ...
    parser.add_argument(
        "--base-url", type=str, default="https://api.deepseek.com", help="API base URL"
